...
App::build(array(
    'Controller' => array(
        ...
        ROOT.DS.APP_DIR.DS.'Controller'.DS.'Agent'.DS,  // 管理画面のコントローラーが収まるディレクトリ
        ROOT.DS.APP_DIR.DS.'Controller'.DS.'Agent'.DS.'Pages'.DS, // 管理画面のコントローラーが収まるディレクトリ
    ...
    'View' => array(
        ...
        ROOT.DS.APP_DIR.DS.'View'.DS.'Agent'.DS, // 管理画面のビューが収まるディレクトリ
        ROOT.DS.APP_DIR.DS.'View'.DS.'Agent'.DS.'Pages'.DS, // 管理画面のコントローラーが収まるディレクトリ
