 <div id="shopInfo" class="main">
  <div class="main_title"><a href="/"><?php echo __('HOME'); ?></a>&nbsp;>&nbsp;<a href="/country"><?php echo __('国管理'); ?></a>&nbsp;>&nbsp;<a href="/country/listcity/<?php echo $countries_id?>"><?php echo __('都市の一覧'); ?></a>&nbsp;>&nbsp;<?php echo __('新規都市の登録'); ?></div>
  ...
  <fieldset ng-controller='shopInfoController'>
    ...
    <?php echo $this->Form->create(false); ?>
      <table>
        ...
        <tr>
          ...
          <td>
            ...
            <?php echo $this->Form->input('City.status', array('type' => 'checkbox', 'div' => false, 'label' => false, 'required' => true, 'checked')); ?>
          </td>
        </tr>
        <!-- <tr>
          <td class="subject"><?php //echo __('国'); ?></td>
          <td>
            <?php //echo $this->Form->input('City.countries_id', array('type' => 'select', 'div' => false, 'label' => false, 'required' => true, 'options' => $countries, 'value' => $countries_id, 'disabled'));?>
          </td>
        </tr> -->
      </table>
      ...
      <div class="btn_center">
        ...
        <!-- onclick="document.location='/country/listcity/<?php echo $countries_id ?>';" -->
        <?php echo $this->Form->submit(__('登録'), array('type' => 'submit', 'div' => false, 'class' => 'btn btn_orange', 'onclick' => 'return confirm(\'' . __('都市情報を登録致します。宜しいでしょうか。') . '\');'));?>
      </div>
