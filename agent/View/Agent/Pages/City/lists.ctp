<div class="main">
  <div class="main_title"><a href="/"><?php echo __('HOME'); ?></a>&nbsp;>&nbsp;<a href="/city"><?php echo __('都市の管理'); ?></a>&nbsp;>&nbsp;<?php echo __('List City'); ?></div>
  ...
  <fieldset>
    ...
    <div><a href="/country/importcity/<?php echo $countries['Country']['id']?>" style="min-width:215px;">&gt;&gt;<?php echo __('リストをインポート'); ?></a></div>
