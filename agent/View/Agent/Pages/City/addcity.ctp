 <div id="shopInfo" class="main">
  <div class="main_title"><a href="/"><?php echo __('HOME'); ?></a>&nbsp;>&nbsp;<a href="/country/lists"><?php echo __('国管理'); ?></a>&nbsp;>&nbsp;<a href="/city/lists/<?php echo $countries_id?>"><?php echo __('都市の一覧'); ?></a>&nbsp;>&nbsp;<?php echo __('新規都市の登録'); ?></div>
    ...
    <?php echo $this->Form->create(false); ?>
      <table>
        ...
        <tr>
          ...
          <td>
            <?php echo $this->Form->input('City.countries_id', array('type' => 'select', 'div' => false, 'label' => false, 'required' => true, 'options' => $countries, 'value' => $countries_id));?>
          </td>
        </tr>
      </table>
