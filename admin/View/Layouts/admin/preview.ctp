...
<body>
  ...
  <div class="smartphone-iphone">
    <div class="smartphone-wrap <?php echo $backgroundInfo['background']['color']; ?>">

    <?php echo $this->element('preview/top'); ?> 

    <br><br>

    <?php echo $this->fetch('content'); ?>

    <?php echo $this->element('preview/footer'); ?> 
    <?php echo $this->element('preview/sidemenu'); ?> 
