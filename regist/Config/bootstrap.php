...
App::build(array(
    'Controller' => array(
        ...
        ROOT.DS.APP_DIR.DS.'Controller'.DS.'Regist'.DS,  // 管理画面のコントローラーが収まるディレクトリ
        ROOT.DS.APP_DIR.DS.'Controller'.DS.'Regist'.DS.'Pages'.DS, // 管理画面のコントローラーが収まるディレクトリ
    ),
    'Model' => array(
    ...
    'View' => array(
        ...
        ROOT.DS.APP_DIR.DS.'View'.DS.'Regist'.DS, // 管理画面のビューが収まるディレクトリ
        ROOT.DS.APP_DIR.DS.'View'.DS.'Regist'.DS.'Pages'.DS, // 管理画面のコントローラーが収まるディレクトリ
    ),
    'Plugin' => array(
