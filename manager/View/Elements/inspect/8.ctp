  <div class="panel-body">
    ...
    <?php echo $this->Form->create('Reject', array('url' => array('controller' => 'inspect', 'action' => 'ios_release', $requestInfo['InspectRequest']['id']))); ?>
      <div class="form-horizontal">
        <div class="form-group">
          <label class="col-sm-2 control-label">&nbsp;</label>
          <div class="col-sm-10 form-inline">
            <p>iOSアプリのリリース作業が完了したら以下のボタンを押してステータスを更新してください。<br>AppStoreへのURLの登録は完了していますか？</p>
            <input type="submit" class="btn btn-default" value="iOSアプリ リリース完了" onclick="return confirm('AppStoreへのURLの登録は完了していますか？\nこのまま更新処理を行いますか？');" />
          </div>
        </div>
      </div>
    <?php echo $this->Form->end();?>
