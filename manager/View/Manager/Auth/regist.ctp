<h2><?php echo __('マスターアカウント発行依頼'); ?><small>&nbsp;|&nbsp;<?php echo __('ログイン'); ?></small></h2>
...
<div id="shopInfo" class="panel panel-default" ng-controller="shopInfoController">
  ...
  <?php echo $this->Form->create(false, array('action' => 'regist', 'novalidate' => true)); ?>
    <div class="panel-body form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <?php echo $this->Form->input('User.password', array('type' => 'password', 'div' => false, 'label' => false, 'class' => 'form-control', 'placeholder' => __('パスワード'), 'value' => ''));?>
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          <?php echo $this->Form->input('User.type', array('type' => 'hidden', 'div' => false, 'label' => false, 'value' => USER_TYPE_NONE));?>
          <?php echo $this->Form->input('User.status', array('type' => 'hidden', 'div' => false, 'label' => false, 'value' => USER_STATUS_KARI));?>
          <a href="/manager/list" class="btn btn-default"><?php echo __('ログイン画面に戻る'); ?></a>
          <button class="btn btn-default" onclick="return confirm('<?php echo __('マスターアカウントの発行の依頼を登録します。\nよろしいですか'); ?>');"><?php echo __('発行依頼'); ?></button>
        </div>
      </div>
    </div>
