<ol class="breadcrumb">
  ...
  <li class="actice"><?php echo __('マスター新規登録'); ?></li>
</ol>

<h2><?php echo __('マスター新規登録'); ?><small>&nbsp;|&nbsp;<?php echo __('マスター'); ?></small></h2>
...
<div id="shopInfo" class="panel panel-default" ng-controller="shopInfoController">
  ...
  <?php echo $this->Form->create(false, array('action' => 'add', 'novalidate' => true)); ?>
    <div class="panel-body form-horizontal">
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          ...
          <a href="/manager/list" class="btn btn-default"><?php echo __('一覧に戻る'); ?></a>
          <button class="btn btn-default" onclick="return confirm('<?php echo __('マスター情報を登録します。\nよろしいですか'); ?>');"><?php echo __('登録'); ?></button>
        </div>
      </div>
    </div>
