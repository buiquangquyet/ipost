...
// Manager関係 WGの人が操作をする
App::build(array(
    'Controller' => array(
        ROOT.DS.APP_DIR.DS.'Controller'.DS, // その他いろいろ共通のやつ
        ROOT.DS.APP_DIR.DS.'Controller'.DS.'Manager'.DS,  // 管理画面のコントローラーが収まるディレクトリ
        ROOT.DS.APP_DIR.DS.'Controller'.DS.'Manager'.DS.'Pages'.DS, // 管理画面のコントローラーが収まるディレクトリ
        ROOT.DS.APP_DIR.DS.'Controller'.DS.'Manager'.DS.'Pages'.DS.'Support'.DS, // 管理画面サポート関係のコントローラーが収まるディレクトリ
    ),
    'Model' => array(
        ...
        CAKE_DIR.DS.'models'.DS.'Logic'.DS.'Shop'.DS,       // 店舗情報設定用のモデルが収まるディレクトリ
        CAKE_DIR.DS.'models'.DS.'Logic'.DS.'Web'.DS,        // ウェブ情報設定用のモデルが収まるディレクトリ
    ),
    'View' => array(
        ROOT.DS.APP_DIR.DS.'View'.DS,
        ROOT.DS.APP_DIR.DS.'View'.DS.'Manager'.DS, // 管理画面のビューが収まるディレクトリ
        ROOT.DS.APP_DIR.DS.'View'.DS.'Manager'.DS.'Pages'.DS, // 管理画面のコントローラーが収まるディレクトリ
    ),
    'Plugin' => array(
