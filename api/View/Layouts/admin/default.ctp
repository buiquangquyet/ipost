		...
		<div id="main_box">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<section class="panel2 center navi_c">
					...
					<div class="menu_txt center">
						<?php echo $this->Html->link('スプラッシュ', array('controller' => 'splash', 'action' => 'index')); ?>
					</div>
				</section>
			</div>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<section class="panel2 center navi_c">
					...
					<div class="menu_txt center">
						<?php echo $this->Html->link('ヘッダー', array('controller' => 'header', 'action' => 'index')); ?>
					</div>
				</section>
			</div>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<section class="panel2 center navi_c">
					...
					<div class="menu_txt center">
						<?php echo $this->Html->link('背景', array('controller' => 'background', 'action' => 'index')); ?>
					</div>
				</section>
			</div>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<section class="panel2 center navi_c">
					...
					<div class="menu_txt center">
						<?php echo $this->Html->link('フッター', array('controller' => 'footer', 'action' => 'index')); ?>
					</div>
				</section>
			</div>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<section class="panel2 center navi_c">
					...
					<div class="menu_txt center">
						<?php echo $this->Html->link('店舗情報', array('controller' => 'shop', 'action' => 'profile')); ?>
					</div>
				</section>
			</div>
