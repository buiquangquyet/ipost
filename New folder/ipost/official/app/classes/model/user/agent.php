...
class Model_User_Agent extends Model_Crud
{
    /**
     * @var  string  $_table_name  The table name
     */
    protected static $_table_name = 'USER_AGENT';
     ...
     * @return
     */
    public static function get_agent_name($agent_id)
    {
        $agent = self::find_by_pk($agent_id);
        return is_null($agent) ? '' : $agent->agent_name;
    }
}