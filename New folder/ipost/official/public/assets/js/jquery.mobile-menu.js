...
var img = '<img src="/assets/img/menu_btn.png" alt="メニューボタン" class="menu_btn" />';
  MobileMenu.prototype = {
    ...
    setLayout: function(){
      ...
      $("#"+_this.config.page_id).prepend('<div id="build-menu-overlay" />'+'<a href="javascript:void(0);" id="menu_close">');
      ...
      $("#build-menu-button, #build-menu-overlay, #menu_close").on("click", function(e){
        e.preventDefault();
        var html = $("html");
